...
(UBL)](http://ubl.xml.org/) standard, on sale orders. The UBL 2.1
...
With this module, when you generate the sale order or RFQ report:

- on a draft/RFQ/Bid Received sale order, the PDF file will have an
  embedded XML *Request For Quotation* file compliant with the UBL 2.1
  or 2.0 standard.
- on an approved sale order, the PDF file will have an embedded XML
